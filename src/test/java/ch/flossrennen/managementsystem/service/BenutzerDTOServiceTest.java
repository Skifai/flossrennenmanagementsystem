...
class BenutzerDTOServiceTest {
    ...
    void save_DuplicateEmail_ReturnsFailure() {
        BenutzerDTO dto1 = new BenutzerDTO(null, "Hans", "Muster", "0791234567", "duplicate@test.ch", "hash", "ADMIN");
        service.save(dto1);

        BenutzerDTO dto2 = new BenutzerDTO(null, "Peter", "Lustig", "0797654321", "duplicate@test.ch", "hash", "USER");
